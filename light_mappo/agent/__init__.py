...
# MODEL_DIR = "/home/user/Desktop/git/light_mappo/scripts/results/MyEnv/MyEnv/mappo/check/run5/models/actor.pt"
...
class Agent(object):
    ...
    def act(self, obs):
        ...
        masks = np.ones((self.num_evn, self.num_agent, 1), dtype=np.float32)
